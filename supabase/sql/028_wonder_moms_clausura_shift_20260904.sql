...
with event_rows(jornada, title, type, team, opponent, uniform, location, datetime) as (
  values
    ...
    (3, 'Wonder Moms J3 - Golden Dream vs Golden Power', 'Partido'::public.gm_event_type, 'Dreams', 'Golden Power', null::text, 'Zapping Sport Center - Club Palestino', make_timestamptz(2026, 9, 24, 20, 0, 0, 'America/Santiago')),
    (3, 'Wonder Moms J3 - Golden Dream vs Golden Power', 'Partido'::public.gm_event_type, 'Power', 'Golden Dream', null::text, 'Zapping Sport Center - Club Palestino', make_timestamptz(2026, 9, 24, 20, 0, 0, 'America/Santiago')),
